...
const YveBot = require('yve-bot');

const app = express();
const server = http.Server(app);
const io = SocketIO(server);

const yml = yaml.safeLoad(fs.readFileSync(__dirname + '/static/chat.yaml', 'utf8'));
const bot = new YveBot(yml);
...
app.use('/chat.css', express.static(__dirname + '/static/chat.css'));
app.use('/web.js', express.static(__dirname + '/static/web.js'));
